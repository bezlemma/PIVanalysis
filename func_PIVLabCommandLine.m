function [u_filt, v_filt] = func_PIVLabCommandLine(directory)


%This function runs PIV, to allow for batch processing of PIV exerpiments
...
% Settings
%umin = -10*nanmean(abs(u)); % minimum allowed u velocity
%umax = 10*nanmean(abs(u)); % maximum allowed u velocity
%vmin = -10*nanmean(abs(v)); % minimum allowed v velocity
%vmax = 10*nanmean(abs(v)); % maximum allowed v velocity
