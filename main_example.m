ROOT = 'PATH\TO\EXAMPLE\DATA\GOES\HERE';
...
[CORR_LIST]   = func_find_correlation_length(U_VEL_FIELD, V_VEL_FIELD , tmin, step, 30, SCALE,PIV_BIN, MID_POINT , X_BUFFER , FIT_START_POINT);
